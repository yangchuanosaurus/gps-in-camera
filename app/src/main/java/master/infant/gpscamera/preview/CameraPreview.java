...
abstract class CameraPreview<T extends View, Output> {
    ...
    private final static CameraLogger LOGGER = CameraLogger.create(CameraPreview.class.getSimpleName());
    ...
    void setDesiredSize(int width, int height) {
        LOGGER.i("setDesiredSize:", "desiredW=", width, "desiredH=", height);
    ...
    protected final void onSurfaceAvailable(int width, int height) {
        LOGGER.i("onSurfaceAvailable:", "w=", width, "h=", height);
        mSurfaceWidth = width;
    ...
    protected final void onSurfaceSizeChanged(int width, int height) {
        LOGGER.i("onSurfaceSizeChanged:", "w=", width, "h=", height);
    ...
    private final void crop() {
        ...
        getView().post(new Runnable() {
            ...
            public void run() {
                ...
                LOGGER.i("crop:", "applied scaleX=", scaleX);
                LOGGER.i("crop:", "applied scaleY=", scaleY);
                mCropTask.end(null);
            }
        });
    }
